...
**Response**:
# adelie penguins have the lowest mean flipper length and Gentoo have the highest mean flipper length
...
**Response**:
# boxplot is better because it shows a 5 number summary and a lot easier to read for overall but jitter shows more on each individual 
